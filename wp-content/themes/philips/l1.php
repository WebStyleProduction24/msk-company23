...
<section id="etapi">
  <div class="container">
    <h4 class="fgfgf">Этапы выполнения работ</h4>
    <div class="col-md-12">
      <div class="one-5">
...
<section id="services">
  <div class="container">
    ...
    <div class="col-md-12">
      ...
      <div class="col-md-4">
        ...
        <p class="servic">Ландшафтный диайн</p>
      </div>  
      <div class="col-md-4">
  ...
  <section id="contacts">
    <div class="container">
      <div class="karta">
        <script type="text/javascript" charset="utf-8" async src="https://api-maps.yandex.ru/services/constructor/1.0/js/?sid=kgYQkrVKh7kRp4VjaVYNY2altO4Zpw0G&amp;width=100%&amp;height=450&amp;lang=ru_RU&amp;sourceType=constructor&amp;scroll=true"></script>
      </div>
      <div class="col-md-12">
